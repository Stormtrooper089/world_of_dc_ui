  ...
  return (
    <div className="min-h-screen overflow-x-hidden bg-slate-50 text-slate-900">
      ...
      <section className="relative z-20 -mt-8 mb-5 max-w-full overflow-hidden sm:-mt-10" id="services">
        <div className="mx-auto w-full max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="w-full max-w-full overflow-hidden rounded-xl border border-slate-200 bg-white p-2 shadow-[0_18px_35px_rgba(15,23,42,0.12)] sm:p-3">
            <div className="grid w-full max-w-full grid-cols-1 gap-2 min-[440px]:grid-cols-2 sm:grid-cols-4">
              {quickServices.map((service, index) => {
                ...
                return (
                  <button
                    ...
                    className={`group flex min-h-[108px] min-w-0 flex-col items-center rounded-lg px-2 py-3 text-center focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-600/60 transition-colors sm:min-h-[124px] ${
                      isInteractive
                  ...
                  >
                    <div
                      className={`mb-2 flex h-11 w-11 items-center justify-center rounded-lg shadow-sm sm:h-12 sm:w-12 ${service.accentBg}`}
                    >
                      <service.icon
                        className={`h-5 w-5 sm:h-6 sm:w-6 ${service.iconColor}`}
                      />
                    </div>
                    <p className="max-w-full break-words text-[11px] font-bold uppercase leading-tight tracking-[0.08em] text-slate-900 sm:text-xs">
                      {service.name}
                    </p>
                    <p className="mt-1 max-w-full break-words text-[11px] leading-snug text-slate-500 sm:text-xs">
                      {service.description}
                    </p>
                  </button>
                );
      ...
      <section className="mb-6 max-w-full overflow-hidden">
        <div className="mx-auto w-full max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid w-full max-w-full grid-cols-1 divide-y divide-slate-200 overflow-hidden rounded-xl border border-slate-200 bg-white shadow-sm min-[440px]:grid-cols-2 min-[440px]:divide-x sm:grid-cols-4 sm:divide-y-0">
            {civicStats.map((stat) => (
